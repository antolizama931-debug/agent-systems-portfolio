...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| BM25 | measured | 87.50% | 95.83% | 100.00% | 95.83% | 0.138 | 0.134 | 0.188 | 60 |
| Dense | measured | 87.50% | 91.67% | 95.83% | 93.75% | 5.261 | 5.160 | 6.209 | 60 |
| Hybrid RRF | measured | 79.17% | 87.50% | 95.83% | 89.17% | 5.257 | 5.284 | 6.495 | 60 |

Dense 首次查询冷启动耗时：`1011.926 ms`。该值包含模型初始化和全语料 embedding，不能与 warm P50 直接比较。
...
| Agent Run 重复次数 | 20 |
| Agent Run 平均墙钟耗时 (ms) | 3.004 |
| Agent Run P50/P95 (ms) | 2.965 / 3.369 |
| 每次工具调用数 | 5.000 |
| API 唯一路径数 | 17 |
